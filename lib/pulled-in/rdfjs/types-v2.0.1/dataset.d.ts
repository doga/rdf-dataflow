...
import { Quad, BaseQuad, Term } from './data-model.d.ts';
// import { Stream } from './stream.d.ts'; // BUG ⚠️🪲 DON'T USE THE `Dataset` type! Pulling this into this repo does not work. 
